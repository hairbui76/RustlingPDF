...
/**
 * Configures the shared Supabase client against the RustlingPDF Supabase project so
 ...
 * — the one RustlingPDF Supabase project every flavor talks to (same vars the editor
