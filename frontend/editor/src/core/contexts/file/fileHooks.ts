...
import { RustlingFileStub, RustlingFile } from "@app/types/fileContext";
 ...
 */
export function useCurrentFile(): { file?: File; record?: RustlingFileStub } {
...
export function useFileManagement() {
  ...
  return useMemo(
    () => ({
      ...
      updateRustlingFileStub: actions.updateRustlingFileStub,
 ...
 */
export function useRustlingFileStub(fileId: FileId): {
  file?: File;
  record?: RustlingFileStub;
} {
  const { state, selectors } = useFileState();
  ...
  return useMemo(
    () => ({
      ...
      record: selectors.getRustlingFileStub(fileId),
    }),
...
export function useAllFiles(): {
  ...
  return useMemo(
    () => ({
      ...
      fileStubs: selectors.getRustlingFileStubs(),
...
export function useSelectedFiles(): {
  ...
  selectedFileStubs: RustlingFileStub[];
  ...
  return useMemo(
    () => ({
      ...
      selectedFileStubs: selectors.getSelectedRustlingFileStubs(),
      selectedFileIds: state.ui.selectedFileIds,
    }),
    [state.ui.selectedFileIds, state.files.byId, selectors],
  );
