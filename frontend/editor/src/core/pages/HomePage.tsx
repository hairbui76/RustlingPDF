...
export default function HomePage() {
  ...
  const brandAltText = t("home.mobile.brandAlt", "RustlingPDF logo");
  ...
  const appName = config?.appNameNavbar || "RustlingPDF";
  useDocumentMeta({
        ...
        {isMobile ? (
          ...
          >
            <MyFilesAwareFileSidebar
              ...
              toggleIcon={
                navigationState.workbench === "myFiles" ? (
                  <LocalIcon icon="arrow-back-rounded" />
                ) : undefined
              }
              onToggleCollapse={() => {
                if (navigationState.workbench === "myFiles") {
  ...
  function MyFilesSidebarOverrides(props, ref) {
    ...
    return (
      <FileSidebar
        ...
        extraAction={{
          icon: <LocalIcon icon="create-new-folder-rounded" />,
