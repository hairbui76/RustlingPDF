...
This directory contains Python scripts for managing frontend translations in RustlingPDF. These tools help analyze, merge, validate, and manage translations against the en-US golden truth file.

## Current Format: TOML

**RustlingPDF uses TOML format for translations** in `frontend/editor/public/locales/{lang}/translation.toml`.
...
- Uses GPT-5.6 with specialized prompts for RustlingPDF
...
- Specialized system prompts for RustlingPDF translations
