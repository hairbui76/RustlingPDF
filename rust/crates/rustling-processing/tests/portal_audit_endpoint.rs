...
fn secured_app_with_settings(
    ...
    let store = rustling_processing::security_http::initialize_security_store(&runtime_config)?;
    let config = SecurityHttpConfig {
        ...
        audit_file_capture: rustling_processing::security_http::SecurityAuditFileCaptureConfig {
