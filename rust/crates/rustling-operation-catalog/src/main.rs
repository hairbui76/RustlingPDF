...
use rustling_operation_catalog::{generate_catalog_json, generate_mcp_supplement_json};
...
const USAGE: &str = "usage: rustling-operation-catalog --spec <SwaggerDoc.json> --output <operation_catalog.json> [--mcp-supplement <mcp_operation_supplement.json>] [--check]";
